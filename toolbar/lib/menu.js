...
(function() {
  var Menu, MenuBar, MenuBase, MenuButton, MenuItem, Separator, ToolBar, ToolButton, complex1, complex2, menu1, menu2, simple, simple2, withIcon,
  ...
  Menu = (function(_super) {
    ...
    Menu.prototype.render = function() {
      ...
      if (!(this.el != null)) {
        this.el = Menu.__super__.render.call(this);
        _ref = this.items;
    ...
    MenuItem.prototype.render = function() {
      ...
      if (!(this.el != null)) {
        ...
        if (this.isChecked) {
          ...
          this._newDiv('checked-icon').append('\u2713').appendTo(this.el);
        }
        if (this.text != null) {
  ...
  window.exampleTool = new ToolBar([
